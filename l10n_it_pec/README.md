...
| NS | Notifica di Scarto | `invalid` |
| MC | Mancata Consegna | `awaiting` |
| AT | Attestazione | `delivered` |
| DT | Decorrenza Termini | `delivered` |
| NE (EC01) | Esito: Accettazione | `delivered` |
| NE (EC02) | Esito: Rifiuto | `invalid` |
