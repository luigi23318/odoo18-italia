...
class AccountMove(models.Model):
    ...
    @api.depends('l10n_it_partner_is_public_administration')
    ...
    def _l10n_it_pec_is_pa_invoice(self):
        ...
        Usa il campo standard l10n_it_partner_is_public_administration di l10n_it_edi
        (country IT + codice destinatario di 6 caratteri).
        """
        self.ensure_one()
        return self.l10n_it_partner_is_public_administration
