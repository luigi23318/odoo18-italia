...
class AccountMove(models.Model):
    ...
    def _l10n_it_pec_generate_xml(self):
        ...
        # Usa il metodo standard di Odoo 18 per generare l'XML
        # Questo garantisce compatibilità totale con il formato FatturaPA
        xml_content, errors = self._l10n_it_edi_export_invoice_as_xml()
