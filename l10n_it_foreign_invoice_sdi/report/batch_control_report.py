        ...
        for batch in batches:
            for inv in batch.invoice_ids:
                ...
                if inv.line_ids:
                    ...
                    if inv.amount_untaxed and abs(line_sum - inv.amount_untaxed) > 0.01:
                        warnings.append({
                            'invoice': inv.name,
                            'type': 'math',
                            'message': (
                ...
                if inv.supplier_vat and not inv.partner_id:
                    warnings.append({
                        ...
                        'type': 'partner',
                        'message': (
                            f'P.IVA {inv.supplier_vat} non trovata in anagrafica'
                        ),
                    })
                ...
                if inv.reception_date and inv.tipo_documento:
                    ...
                    if inv.tipo_documento in ('TD17', 'TD18'):
                        deadline = (
